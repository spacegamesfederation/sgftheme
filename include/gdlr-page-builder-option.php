			...
			$title = array(
				'title-type'=> array(	
					...
					'options'=> array(
						...
						'left-caption'=> __('Left Align (Style 2 Caption)' ,'gdlr_translate'),
				...
				'title-size'=> array(	
					'title'=> __('Title Size' ,'gdlr_translate'),
					'type'=> 'combobox',
					'options'=> array(
					...
					'default'=> 'large',
					'wrapper-class'=>'title-type-wrapper left-wrapper left-caption-wrapper center-wrapper left-divider-wrapper center-divider-wrapper'
				),										
				'title'=> array(	
					...
					array(
						...
						'content-item' => array(
							...
							'options' => array(
								...
								'accommodation' => array(
									'title'=> __('Accommodation', 'gdlr_translate'), 
									'type'=>'item',
									'options'=> array(
										'image'=> array(
										...
										'rating'=> array(
											'title'=> __('Rating' ,'gdlr_translate'),
											'type'=> 'combobox',						
											'options'=> array(
												'none' => 'None',
												'0' => '0', '1' => '0.5', '2' => '1', '3' => '1.5', 
										...
										'button-text'=> array(
											'title'=> __('Button Text' ,'gdlr_translate'),
											'type'=> 'text',
										),	
										'button-link'=> array(
											'title'=> __('Button Link' ,'gdlr_translate'),
											'type'=> 'text',
										),	
									)
								),
						...
						'media-item' => array(
							...
							'options' => array(
								...
								'subscribe' => array(
									'title'=> __('Subscribe', 'gdlr_translate'), 
									'type'=>'item',
									'options'=>array(		
										'title'=> array(
											'title'=> __('Title' ,'gdlr_translate'),
											'type'=> 'text',
											'default'=> __('Subscribe for updates', 'gdlr_translate'),
											'description'=> __('You have to install the newsletter plugin to make this item works properly', 'gdlr_translate')
										),			
										'margin-bottom' => array(
											'title' => __('Margin Bottom', 'gdlr_translate'),
											'type' => 'text',
