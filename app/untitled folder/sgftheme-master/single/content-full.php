...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="gdlr-standard-style">
		...
		<div class="blog-content-wrapper" >
			<div class="post-header-wrapper" > <!-- comment out to temporarily remove date
				<div class="gdlr-blog-date-wrapper gdlr-info-font">
					<div class="gdlr-blog-day"><?php // comment out to temporarily remove date echo get_the_time('j'); ?></div>
					<div class="gdlr-blog-month"><?php // comment out to temporarily remove date echo get_the_time('M'); ?></div>
				</div> -->
