 ...
 */
	...
	$header_background = '';
	$header_title_class  = empty($gdlr_post_option['page-title-style'])? 'normal': $gdlr_post_option['page-title-style'];
	$header_title_class  = 'gdlr-title-' . $header_title_class;
...
?>
	...
	<?php $page_background = ''; ?>
		<div class="gdlr-page-title-wrapper gdlr-parallax-wrapper <?php echo esc_attr($header_title_class); ?>" <?php echo $header_background; ?> data-bgspeed="<?php echo empty($theme_option['page-title-background-speed'])? 0: $theme_option['page-title-background-speed']; ?>" >
